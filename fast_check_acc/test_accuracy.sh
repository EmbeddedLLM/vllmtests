...
--trust-remote-code --swap-space 16 --distributed-executor-backend mp \
--input-len 32 --output-len 128 --batch-size 8 --n 1 --num-iters-warmup 10 --num-iters 10 \
> FINAL_deepseek-ai_DeepSeek-V3-v1-aiterlinear.log 2>&1
...
# --trust-remote-code --swap-space 16 --distributed-executor-backend mp \
# --input-len 32 --output-len 128 --batch-size 8 --n 1 --num-iters-warmup 10 --num-iters 10 \
# > FINAL_deepseek-ai_DeepSeek-V3-v0-noaiter.log 2>&1
...
# --trust-remote-code --swap-space 16 --distributed-executor-backend mp \
# --input-len 32 --output-len 128 --batch-size 8 --n 1 --num-iters-warmup 10 --num-iters 10 \
# > FINAL_deepseek-ai_DeepSeek-V3-v0-noaiter-tritonmla.log 2>&1

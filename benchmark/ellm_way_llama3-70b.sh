...
declare -A env_vars=(    
    ...
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 2048 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 4096 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 8192 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 16384 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 32768 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 2048 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 4096 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 8192 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 16384 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 32768 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=4,5 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=TRUE SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_RMSNORM=0"
...
main() {
    ...
    for test_case in "${test_cases[@]}"; do
        res_dir="ellm_way/prefil_decoder_attn_true/${folder_name[$test_case]}"

        echo "Running online serving benchmark for: $test_case"
        log_file="logs_3/$(get_log_filename "$test_case")"
        server_log_file="logs_3/serverlog_$(get_log_filename "$test_case")"
        ...
        eval "$full_env vllm serve ${model_params[$test_case]} --trust-remote-code --distributed-executor-backend mp --swap-space 16 --disable-log-requests --port 8005 $SUFFIX >> $server_log_file &"
        server_pid=$!

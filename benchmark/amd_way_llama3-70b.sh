...
declare -A env_vars=(    
    ...
    # ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 2048 yes prefix caching yes aiter"]="VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 4096 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 8192 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 16384 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 32768 yes prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 2048 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 4096 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 8192 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 16384 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0  VLLM_ROCM_USE_AITER_RMSNORM=0"
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 32768 no prefix caching yes aiter"]="HIP_VISIBLE_DEVICES=2,3 VLLM_V1_USE_PREFILL_DECODE_ATTENTION=1 SAFETENSORS_FAST_GPU=1 VLLM_USE_V1=1 VLLM_ROCM_USE_AITER=1 VLLM_ROCM_USE_AITER_MHA=0 VLLM_ROCM_USE_AITER_RMSNORM=0"
...
declare -A model_params=(
    # ["meta-llama/Llama-3.1-70B-Instruct v1 no aiter"]="meta-llama/Llama-3.1-70B-Instruct -tp 1 " # all args are default in this case (by default enables prefix caching)
    # ["meta-llama/Llama-3.1-70B-Instruct v1 yes aiter"]="meta-llama/Llama-3.1-70B-Instruct -tp 1"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 yes prefix yes aiter"]="meta-llama/Llama-3.1-70B-Instruct -tp 1"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 no prefix yes aiter"]="meta-llama/Llama-3.1-70B-Instruct -tp 1"
    ...
    ["meta-llama/Llama-3.1-70B-Instruct v1 Chunked Size 32768 no prefix caching yes aiter"]="meta-llama/meta-llama/Llama-3.1-70B-Instruct -tp 2 --max_num_batched_tokens 32768 --gpu_memory_utilization 0.95 --no-enable-prefix-caching"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 yes aiter block size 8"]="meta-llama/Llama-3.1-70B-Instruct -tp 1  --block-size 8"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 yes aiter block size 16"]="meta-llama/Llama-3.1-70B-Instruct -tp 1 --block-size 16"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 yes aiter block size 32"]="meta-llama/Llama-3.1-70B-Instruct -tp 1 --block-size 32"
    # ["meta-llama/Llama-3.1-70B-Instruct v1 yes aiter block size 64"]="meta-llama/Llama-3.1-70B-Instruct -tp 1 --block-size 64"
)
...
main() {
    ...
    for test_case in "${test_cases[@]}"; do
        res_dir="amd_way/prefil_decoder_attn_true/${folder_name[$test_case]}"

        echo "Running online serving benchmark for: $test_case"
        log_file="logs_1/$(get_log_filename "$test_case")"
        server_log_file="logs_1/serverlog_$(get_log_filename "$test_case")"
        ...
        if [ -n "$DATASET" ]; then
            for y in "${!cons[@]}"; do
                ...
                python3 /path/to/vllm/benchmarks/benchmark_serving.py \
                    ...
                    --num-prompts 640 \
                    --save-result \
                    --max-concurrency "$_con" \
                    --result-filename "sharegpt-$_con.json" \
        ...
        for i in "${!in_len[@]}"; do
            ...
            for y in "${!cons[@]}"; do
                ...
                python3 /path/to/vllm/benchmarks/benchmark_serving.py \
                    ...
                    --save-result \
                    --result-filename "ISL-$_in_len-OSL-$_out_len-CON-$_con.json" \
                    --result-dir "/path/to/$res_dir" \
                    --max-concurrency "$_con" \
                    --port 8007 \
